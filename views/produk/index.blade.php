		...
		<div class="row">
			...
			<div class="span12" data-motopress-type="static" data-motopress-static-file="static/static-title.php">
				...
				<section class="title-section">
					...
					<h1 class="title-header">Produk Kami</h1>

					<!-- BEGIN BREADCRUMBS-->

					<ul class="breadcrumb breadcrumb__t"><a class="home" href="http://toylogy.com">Home</a> {{$breadcrumb}}		
		...
		<div class="row">
			...
			<div class="span9 right" id="content">
				...
				<form class="woocommerce-ordering">
					...
					<select name="orderby" class="orderby" style="width: 112px;" id="show" data-rel="{{URL::current()}}">
				...
				<ul class="products">
					...
					@foreach(list_product(null,@$category,@$collection) as $key => $products)
